    ...
    <main id="hero" className='flex min-h-screen flex-col bg-[#F4F4F5] items-center justify-start px-4 pt-40 pb-24 sm:px-6'>
      <div className='mx-auto w-full max-w-4xl text-center'>
        ...
        <p className='mx-auto mt-6 max-w-xl text-balance text-center text-muted-foreground md:max-w-2xl md:text-lg'>
          Go from idea to income in record time. A modern boilerplate that saves you weeks of setup
          so you can spend time building features that actually make money.{' '}
        </p>
